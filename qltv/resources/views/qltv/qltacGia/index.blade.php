                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="actions d-flex gap-4">
                                                    <a href="{{ route('qltv.qltg.edit', $author) }}" class="btn btn-warning btn-sm">Sửa</a>
                                                    <form method="POST" action="{{ route('qltv.qltg.destroy', $author) }}" style="margin: 0;" onsubmit="return confirm('Bạn có chắc muốn xóa sách này?')">
                                                        @csrf
                                                        @method('DELETE')
