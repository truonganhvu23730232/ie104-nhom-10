                    ...
                    <div class="mb-2">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Thêm tác giả</li>
                            </ol>
                        </nav>
                    </div>
                </div>

                <form method="POST" action="{{ route('qltv.qltg.store') }}">
                    @csrf
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-success">Lưu tác giả</button>
                        <a href="{{ route('qltv.qltg') }}" class="btn btn-danger">Hủy</a>
                    </div>
                </form>
            </div>
        </div>
